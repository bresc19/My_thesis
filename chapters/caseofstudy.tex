...
The given procedure and validation results are available on GitHub at this page
...
Results from different periods for simplicity are grouped and averaged. In total in this work are attached 8 different results. Each results will be in detail pointed in the final Appendix \ref{chap:appendix}.
\begin{figure}[H]
    \centering
