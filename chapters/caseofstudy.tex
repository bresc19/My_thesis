...
After that, I transform each cluster of variables using the first \gls{pca} component. In this way, I solve collinearity in the independent variables, without particularly losing the features interpretability.\\
