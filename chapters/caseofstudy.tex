...
Behind is attached the groups of collinear variables and the new covariates used in the Feature Selection, with a 10 km resolution and including mountain zones.
\begin{verbatim}
**********
cluster_0
...
\end{verbatim}
I group and show (Figure ) collinear variables in clusters with the help of a script available at this underline{\href{https://www.kaggle.com/code/nassehkhodaie/fixing-multicollinearity-by-feature-clustering/data?select=collinearity_finder_treater_py.py} link}.
Below are shown the group of variables avergaed with PCA.
\begin{figure}
