...
\item Drop of columns (values assumed by each covariates) having at least a NaN value(dropna(axis = 1));
\end{itemize}
...
The scores are evaluated as attribute (feature\_importances\_) of RandomForestRegressor of the scikit-learn library (sklearn.ensemble).
...
The number of selected variables, as default option of the method, is half the total number of covariates. (TODO)
\pagebreak
