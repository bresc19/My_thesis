...
By litherature we know that interpretability is usually related to a trade-off with accuracy (figure \ref{trade-off}).
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{images/trad.png}
