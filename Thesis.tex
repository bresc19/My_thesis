...
\puttitle{
	title=Feature Selection for \\Interpretable Machine Learning Models, % Title of the thesis
	...
	advisor= Dott. Daniele Oxoli, % Supervisor name
	coadvisor=Prof. Maria Antonia Brovelli, % Co-Supervisor name, remove this line if there is none
...
\textbf{Keywords:} Feature selection, Machine Learning, Interpretability, D-DUST % Keywords

% ABSTRACT IN ITALIAN
\chapter*{Abstract in lingua italiana}
\input{chapters/abstract_ita.tex}

\textbf{Parole chiave:} Feature Selection, Machine Learning, Interpretabilità, D-DUST
